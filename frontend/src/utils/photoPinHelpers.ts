    ...
    return [
      {
        ...
        object_position: typeof pin.media.object_position === "string" ? pin.media.object_position : "50% 50%",
        photoPositionX: Number(pin.media.photoPositionX ?? 50),
        photoPositionY: Number(pin.media.photoPositionY ?? 50),
